...
from stable_baselines.a2c.utils import conv, conv1d, linear, conv_to_fc, batch_to_seq, seq_to_batch, lstm
...
def laser_cnn(state, **kwargs):
    ...
    layer_2 = activ(conv1d(layer_1, 'c2', n_filters=32, filter_size=3, stride=2, init_scale=np.sqrt(2), **kwargs))
